...
#### 멀티캐스트 그룹
**멀티캐스트 도메인**의 멀티캐스트 통신에 참여할 **네트워크 인터페이스**들을 **멀티캐스트 그룹**으로 설정하고 관리 합니다. **멀티캐스트 그룹**설정에 의해 동일한 **그룹 IP 주소**를 가진 **네트워크 인터페이스** 간에 통신을 하게 됩니다.
[참고] VM Instance의 **네트워크 인터페이스**만 멀티캐스트 그룹으로 설정할 수 있습니다.
