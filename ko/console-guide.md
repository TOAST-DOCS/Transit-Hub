...
#### 라우팅 연결
**라우팅 테이블**이 패킷을 수신하기 위한 **연결**과의 관계를 생성하는 **라우팅 연결**을 관리 합니다.
...
#### 라우팅 전파
**라우팅 테이블**에서 패킷을 송신 정책을 관리하는 **라우팅 룰**을 자동으로 생성할 수 있습니다. **라우팅 룰**자동 생성을 위한 **연결**과의 관계를 정의하는 **라우팅 전파**를 관리 합니다.
> [주의]
> * 전파될 CIDR과 동일한 대역의 **라우팅 룰**이 이미 존재하는 경우 **라우팅 전파**에 의햔 **라우팅 룰**이 자동으로 등록 되지 않습니다.
...
#### 멀티캐스트 그룹
**멀티캐스트 도메인**에서 제공되는 멀티캐스트 통신에 참여할 **네트워크 인터페이스**들을 **멀티캐스트 그룹**으로 관리 합니다. **멀티캐스트 그룹**설정에 의해 동일한 **그룹 IP 주소**를 가진 **네트워크 인터페이스** 간에 멀티캐스트 통신을 하게 됩니다.<br>
