...
> [주의]
> * 둥일한 Network 대역(CIDR)을 가진 2개 이상의 **연결**에 대해서 **라우팅 전파**를 각각 등록하게 되면 임의로 1개의 **연결**에 선택되어 **라우팅 룰** 이 자동 등록 됩니다.
> * 전파될 CIDR과 동일한 대역의 **라우팅 룰**  이미 존재하는 경우 **라우팅 전파**에 의햔 **라우팅 룰**자동 등록이 되지 않습니다. 
