...
3. 생성 화면에서 트랜짓 허브에 대한 정보를 입력합니다.
    ...
    * 기본 라우팅 테이블 연결: **연결**이 생성될 때 기본 라우팅 테이블에 자동으로 연결합니다.
    > [참고] 공유받은 트랜짓 허브에서 생성한 **연결**은 기본 자동으로 연결이 되지 않습니다.
    * 기본 라우팅 테이블 전파: **연결**과 연관된 VPC의 CIDR 설정값을 기본 라우팅 테이블에 **라우팅 룰**로 자동 추가합니다.
    > [참고] 공유받은 트랜짓 허브에서 생성한 **연결**은 기본 자동으로 전파가 되지 않습니다.
> [주의]
...
3. **트랜짓 허브 공유** 버튼을 클릭한 후 공유 화면에서 공유 받을 상대방의 **테넌트 ID**를 입력합니다. <br>
...
1. **Network > Transit Hub > 관리**로 이동합니다.
2. 화면의 목록에서 **연결**을 생성할 트랜짓 허브의 **상세 보기** 버튼을 클릭합니다.
3. **연결**로 이동합니다.
4. **연결 생성** 버튼을 클릭하면 생성 화면이 나타납니다.
5. 생성 화면에서 **연결**에 대한 정보를 입력합니다.
    * 이름: **연결**의 이름을 입력합니다.
    * 설명: **연결**의 설명을 기술합니다.
...
1. **Network > Transit Hub > 관리**로 이동합니다.
2. 화면의 목록에서 **연결**을 변경할 트랜짓 허브의 **상세 보기** 버튼을 클릭합니다.
3. **연결**로 이동합니다.
4. 화면의 목록에서 변경할 **연결**을 선택합니다.
...
1. **Network > Transit Hub > 관리**로 이동합니다.
2. 화면의 목록에서 **연결**을 삭제할 트랜짓 허브의 **상세 보기** 버튼을 클릭합니다.
3. **연결**로 이동합니다.
4. 화면의 목록에서 삭제할 **연결**을 선택합니다.
...
1. **Network > Transit Hub > 관리**로 이동합니다.
2. 화면의 목록에서 **라우팅 테이블**을 생성할 트랜짓 허브의 **상세 보기** 버튼을 클릭합니다.
3. **라우팅 테이블**로 이동합니다.
...
1. **Network > Transit Hub > 관리**로 이동합니다.
2. 화면의 목록에서 **라우팅 테이블**을 변경할 트랜짓 허브의 **상세 보기** 버튼을 클릭합니다.
3. **라우팅 테이블**로 이동합니다.
4. 화면의 목록에서 변경할 **라우팅 테이블**을 선택합니다.
...
1. **Network > Transit Hub > 관리**로 이동합니다.
2. 화면의 목록에서 **라우팅 테이블**을 삭제할 트랜짓 허브의 **상세 보기** 버튼을 클릭합니다.
3. **라우팅 테이블**로 이동합니다.
4. 화면의 목록에서 삭제할 **라우팅 테이블**을 선택합니다.
...
1. **Network > Transit Hub > 관리**로 이동합니다.
2. 화면의 목록에서 **라우팅 테이블** 관리가 필요한 트랜짓 허브의 **상세 보기** 버튼을 클릭합니다.
3. **라우팅 테이블**로 이동합니다.
4. 화면의 목록에서 관리할 **라우팅 테이블**을 선택합니다.
5. **라우팅 연결**로 이동합니다.
6. **라우팅 연결 생성** 버튼을 클릭하면 생성 화면이 나타납니다.
7. 생성 화면에서 **라우팅 연결**에 대한 정보를 입력합니다.
...
7. 생성 화면에서 **라우팅 전파**에 대한 정보를 입력합니다.
...
7. 생성 화면에서 **라우팅 룰**에 대한 정보를 입력합니다.
    * CIDR: 라우팅 정책을 위한 목적지 네트워크 대역을 입력합니다.
    > [참고] 라우팅 테이블에서 **라우팅 룰**들의 우선순위는 **라우팅 룰**에 설정된 CIDR의 Longest Prefix Matching 결과에 의해 결정됩니다.
    * 방식: **CIDR**에 매칭된 패킷의 처리 방법을 선택합니다. **FORWARD**를 선택하면 지정된 **연결**로 패킷을 전달하며, **BLACKHOLE**을 선택하면 패킷을 소멸시킵니다.
...
1. **Network > Transit Hub > 관리**로 이동합니다.
2. 화면의 목록에서 **멀티캐스트 도메인**을 생성할 트랜짓 허브의 **상세 보기** 버튼을 클릭합니다.
3. **멀티캐스트**로 이동합니다.
...
1. **Network > Transit Hub > 관리**로 이동합니다.
2. 화면의 목록에서 **멀티캐스트 도메인**을 변경할 트랜짓 허브의 **상세 보기** 버튼을 클릭합니다.
3. **멀티캐스트**로 이동합니다.
4. 화면의 목록에서 변경할 **멀티캐스트 도메인**을 선택합니다.
...
1. **Network > Transit Hub > 관리**로 이동합니다.
2. 화면의 목록에서 **멀티캐스트 도메인**을 삭제할 트랜짓 허브의 **상세 보기** 버튼을 클릭합니다.
3. **멀티캐스트**로 이동합니다.
4. 화면의 목록에서 삭제할 **멀티캐스트 도메인**을 선택합니다.
...
1. **Network > Transit Hub > 관리**로 이동합니다.
2. 화면의 목록에서 **멀티캐스트 도메인**을 공유할 트랜짓 허브의 **상세 보기** 버튼을 클릭합니다.
3. **멀티캐스트**로 이동합니다.
4. 화면의 목록에서 공유할 **멀티캐스트 도메인**을 선택합니다.
3. **멀티캐스트 도메인 공유** 버튼을 클릭한 후 공유 화면에서 공유 받을 상대방의 **테넌트 ID**를 입력합니다. <br>
> [참고] 다른 프로젝트 **테넌트 ID** 확인 방법
> 다른 프로젝트에 접근 권한이 없을 경우 해당 프로젝트의 관리자로부터 테넌트 ID를 제공받아야 합니다.
> 1. 프로젝트의 콘솔 화면에 접속합니다.
> 2. **Network > VPC > 관리**로 이동합니다.
...
1. **Network > Transit Hub > 관리**로 이동합니다.
2. 화면의 목록에서 **멀티캐스트 도메인** 관리가 필요한 트랜짓 허브의 **상세 보기** 버튼을 클릭합니다.
3. **멀티캐스트**로 이동합니다.
4. 화면의 목록에서 관리할 **멀티캐스트 도메인**을 선택합니다.
5. **멀티캐스트 연결**로 이동합니다.
6. **멀티캐스트 연결 생성** 버튼을 클릭하면 생성 화면이 나타납니다.
7. 생성 화면에서 **멀티캐스트 연결**에 대한 정보를 입력합니다.
...
4. 화면의 목록에서 관리할 **멀티캐스트 도메인**을 선택합니다.
5. **멀티캐스트 연결**로 이동합니다.
6. 화면의 목록에서 삭제할 **멀티캐스트 연결**을 선택합니다.
...
4. 화면의 목록에서 관리할 **멀티캐스트 도메인**을 선택합니다.
5. **멀티캐스트 그룹**로 이동합니다.
6. 화면의 목록에서 삭제할 **멀티캐스트 그룹**을 선택합니다.
7. **멀티캐스트 그룹 삭제** 버튼을 클릭하여 삭제합니다.

## 공유받은 트랜짓 허브

다른 프로젝트가 소유한 트랜짓 허브를 공유 받은 경우 **공유받은 트랜짓 허브**의 목록을 확인하고 통신에 참여할 수 있습니다.
> [참고] 공유받은 트랜짓 허브에서는 아래와 같은 설정이 가능 합니다.
> * 상세 보기 버튼을 클릭하여 연결 및 멀티캐스트를 설정할 수 있습니다.
> * 연결을 생성하여 소유하고 있는 VPC를 공유 받은 트랜짓 허브에 연결할 수 있습니다.
> * 멀티캐스트 도에인을 공유 받은 경우 소유하고 있는 VPC의 subnet을 **멀티캐스트 도메인**에서 관리되는 멀티캐스트 통신에 참여할 수 있습니다.

## 연결(공유받은 트랜짓 허브)

공유 받은 트랜짓 허브와 다른 리소스를 관계를 정의하는 **연결**을 관리합니다.

### 연결 생성

**연결**을 생성하는 방법은 다음과 같습니다.

> [참고] 공유받은 트랜짓 허브에서 생성한 연결은 **기본 라우팅 테이블 연결**, **기본 라우팅 테이블 전파**에 의한 라우팅 테이블 자동 연결 및 라우팅 룰 자동 등록이 되지 않습니다.
...
선택한 공유 받은 **멀티캐스트 도메인**의 기본 정보를 확인하고 멀티캐스트와 연관된 패킷 처리 정책과 설정들을 관리합니다.

#### 멀티캐스트 연결

VPC 타입의 **연결**이 가진 서브넷을 공유 받은 **멀티캐스트 도메인**의 멀티캐스트 네트워크에 합류시키기 위한 **멀티캐스트 연결**을 관리합니다.
> [참고]
> * VPC 타입의 **연결**만 **멀티캐스트 연결**에서 사용할 수 있습니다.
> * 다른 프로젝트에 공유한 트랜짓 허브에 의해서 다른 프로젝트에서 만들어진 **연결**은 **멀티캐스트 연결**에서 사용할 수 없습니다.
> * 1개의 서브넷은 **NHN Cloud** 전체 중 1개의 **멀티캐스트 연결**에서만 사용 가능합니다. 즉, 1개의 **서브넷**은 1개의 **멀티캐스트 도메인**과만 연결이 가능합니다.
...
공유 받은 **멀티캐스트 도메인**에서 제공하는 멀티캐스트 통신에 참여할 **네트워크 인터페이스**들을 **멀티캐스트 그룹**으로 관리합니다. **멀티캐스트 그룹**의 설정에 의해 동일한 **그룹 IP 주소**를 가진 **네트워크 인터페이스**들은 상호 간에 멀티캐스트 통신을 하게 됩니다.<br>
> [참고] VM Instance의 **네트워크 인터페이스**만 멀티캐스트 그룹으로 추가할 수 있습니다.
